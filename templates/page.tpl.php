...
<script>
        var base = Drupal.settings.basePath + 'sites/default/files/bodyslider_images/';
         $.backstretch([
          base + "bodyimage.jpg", 
          base + "bodyimage_0.jpg",
          base + "bodyimage_1.jpg",
          base + "bodyimage_2.jpg",
          base + "bodyimage_3.jpg",
          ], {
